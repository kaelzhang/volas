...
**volas** is a Rust-backed, pandas-shaped `DataFrame` for live OHLCV pipelines: [**246** trading-indicators](INDICATORS.md), incremental O(lookback) refresh, and NumPy/Torch-ready output.
...
- **246** built-in indicators and TA-Lib-compatible directives
