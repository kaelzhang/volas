...
use super::{
    candle_gap_down, candle_gap_up, color, each_bar, each_bar_avg2, lowershadow, realbody,
...
#[inline]
fn is_marubozu(o: &[f64], h: &[f64], l: &[f64], c: &[f64], i: usize, body_long: f64, vs: f64) -> bool {
...
pub fn cdl_piercing(o: &[f64], h: &[f64], l: &[f64], c: &[f64]) -> Vec<f64> {
    ...
    each_bar_avg2([BODY_LONG], lb, o, h, l, c, |i, cur, prev| {
...
pub fn cdl_darkcloudcover(o: &[f64], h: &[f64], l: &[f64], c: &[f64], penetration: f64) -> Vec<f64> {
    let lb = BODY_LONG.avg_period + 1;
    each_bar_avg2([BODY_LONG], lb, o, h, l, c, |i, _cur, prev| {
        if color(o, c, i - 1) > 0.0
            && realbody(o, c, i - 1) > prev[0]
            && color(o, c, i) < 0.0
            && o[i] > h[i - 1]
...
pub fn cdl_kicking(o: &[f64], h: &[f64], l: &[f64], c: &[f64]) -> Vec<f64> {
    ...
    each_bar_avg2([BODY_LONG, SHADOW_VERY_SHORT], lb, o, h, l, c, |i, cur, prev| {
